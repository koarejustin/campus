...
-- Table des devoirs programmés par les professeurs
CREATE TABLE IF NOT EXISTS pedagogie.devoirs (
...
CREATE INDEX IF NOT EXISTS idx_devoirs_classe ON pedagogie.devoirs(classe);
CREATE INDEX IF NOT EXISTS idx_devoirs_date ON pedagogie.devoirs(date_limite);
CREATE INDEX IF NOT EXISTS idx_devoirs_prof ON pedagogie.devoirs(id_prof);

COMMENT ON TABLE pedagogie.devoirs IS 'Devoirs programmés par les professeurs - visibles par les élèves';